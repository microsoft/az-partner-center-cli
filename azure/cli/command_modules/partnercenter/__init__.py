...
from azure.cli.command_modules.partnercenter.manual.cli_parser import CLIParser
from azure.cli.command_modules.partnercenter.manual.plan import PlanCLIParser
