...
from azure.partner_center.confs import ResellerConfiguration
from azure.partner_center.confs.variant import FeatureAvailability
from azure.partner_center.utils import (
    AAD_CRED,
    AAD_ID,
    TENANT_ID,
