...
from azure.partner_center.confs.offer_configurations import ListingOfferConfigurations
from azure.partner_center.confs.variant.variant_plan_configuration import (
