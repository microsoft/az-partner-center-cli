...
def test_co_list_mock(config_yml, monkeypatch, ama_mock, capsys):
    cli_tests.co_list_command(config_yml, monkeypatch, capsys)
...
def test_co_show_mock(config_yml, monkeypatch, ama_mock, capsys):
    cli_tests.co_show_command(config_yml, monkeypatch, capsys)


def test_co_publish_mock(config_yml, monkeypatch, ama_mock, capsys):
    cli_tests.co_publish_command(config_yml, monkeypatch, capsys)


def test_co_delete_mock(config_yml, monkeypatch, ama_mock, capsys):
    cli_tests.co_delete_command(config_yml, monkeypatch, capsys)
